...
public class BasballScheduler {

    private final S3FileService s3FileService;
    private final JdbcTemplate jdbcTemplate;
    @Value("${api.key}")
    private String apiKey;
    private final String filename = "baseball.txt";
    ...
    public void updateTodayMlbGames() throws IOException, InterruptedException {
        ...
        for (int i = 0; i < gameList.length(); i++) {
            ...
            jdbcTemplate.update(updateQuery, awayScore, homeScore, todayString,
